export const blocks = [
  {
    ...
    description: "Get started with your ESP32-C3 by blinking the built-in LED",
    link: "/blocks/blink",
    ...
    prerequisites: `<h3>Before You Begin</h3>
        ...
        <ul>
          ...
          <li>In the "Additional Board Manager URLs" field, add: <code>https://raw.githubusercontent.com/espressif/arduino-esp32/gh-pages/package_esp32_index.json</code></li>
        ...
        <h4>5. Important USB Cable Note</h4>
        <p><strong>⚠️ Use a Data-Capable USB Cable:</strong></p>
        <ul>
          <li>Not all USB cables support data transfer - some are power-only</li>
          <li>If your board isn't recognized, try a different USB cable</li>
          <li>Use the cable that came with your ESP32-C3, or a known good data cable</li>
          <li>If the port doesn't appear, you may need to install USB-to-Serial drivers (CP210x or CH340 drivers)</li>
        </ul>`,
