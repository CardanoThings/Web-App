...
<footer class="mt-4 bg-slate-100 p-4 pb-8 pt-8 dark:bg-slate-900 dark:text-slate-100">
	<div
	...
	>
		...
		<section>
			...
			<a
				href="https://bluesky.app/profile/cardanothings.io"
				target="_blank"
				aria-label="CardanoThings on Bluesky"
			>
